...
image_alt:
  ...
  - 'Three different tree shapes in the OneZoom Tree of Life Explorer'
image_caption:
...
{% figure_img left page.image[1] page.image_alt[1] page.image_caption[1] %}
...
{% figure_img page.image[2] page.image_alt[2] page.image_caption[2] %}
...
{% figure_img page.image[3] page.image_alt[3] page.image_caption[3] %}
